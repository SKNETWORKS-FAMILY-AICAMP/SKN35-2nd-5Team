...
def run_optuna_search(train_loader, test_loader, in_features, n_trials=30, epochs=50):
    def objective(trial):
...
def train_final_model(best_params, in_features, train_loader, test_loader, epochs=100, patience=15):
...
def main():
    ...
    train_loader, test_loader, scaler, in_features = prepare_dataloaders(df)

    best_params = run_optuna_search(train_loader, test_loader, in_features)
    model = train_final_model(best_params, in_features, train_loader, test_loader)
